...
// Inside the ResumeNameList class
class ResumeNameList extends StatelessWidget {
  ...
  void _deleteResume(String name) {
    final personalInfoBox = Hive.box('personal_info');
    personalInfoBox
        .clear(); // Remove all personal info associated with the resume
    // Similarly, clear other boxes containing data related to this resume
  }
}
